...
Local<Object> makeVideo(Local<Value> imageDataCons) {
  ...
  exports->Set(context, JS_STR("Video"), ffmpeg::Video::Initialize(isolate));
  exports->Set(context, JS_STR("VideoDevice"), ffmpeg::VideoDevice::Initialize(isolate, imageDataCons));
...
Local<Object> makeAudio() {
  ...
  exports->Set(context, JS_STR("ScriptProcessorNode"), scriptProcessorNodeCons);
  Local<Value> mediaStreamTrackCons = webaudio::MediaStreamTrack::Initialize(isolate);
  exports->Set(context, JS_STR("MediaStreamTrack"), mediaStreamTrackCons);
  Local<Value> microphoneMediaStreamCons = webaudio::MicrophoneMediaStream::Initialize(isolate, mediaStreamTrackCons);
  exports->Set(context, JS_STR("MicrophoneMediaStream"), microphoneMediaStreamCons);
  exports->Set(context, JS_STR("AudioContext"), webaudio::AudioContext::Initialize(isolate, audioListenerCons, audioSourceNodeCons, audioDestinationNodeCons, gainNodeCons, analyserNodeCons, pannerNodeCons, audioBufferCons, audioBufferSourceNodeCons, audioProcessingEventCons, stereoPannerNodeCons, oscillatorNodeCons, scriptProcessorNodeCons, mediaStreamTrackCons, microphoneMediaStreamCons));
...
Local<Object> makeBrowser() {
  ...
  exports->Set(context, JS_STR("Browser"), browser::Browser::Initialize(isolate));
